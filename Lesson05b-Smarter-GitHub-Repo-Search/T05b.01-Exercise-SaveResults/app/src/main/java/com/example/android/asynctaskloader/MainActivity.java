...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String RAW_JSON = "search_result_json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            String savedUrl = savedInstanceState.getString(SEARCH_URL);
            String savedResults = savedInstanceState.getString(RAW_JSON);
            mUrlDisplayTextView.setText(savedUrl);
            mSearchResultsTextView.setText(savedResults);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String search_url = mUrlDisplayTextView.getText().toString();
        outState.putString(SEARCH_URL,search_url);

        String raw_json = mSearchResultsTextView.getText().toString();
        outState.putString(RAW_JSON,raw_json);
    }
